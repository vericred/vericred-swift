...
public class ProvidersAPI: APIBase {
     ...
     */
    public class func getProvider(npi npi: String, completion: ((data: ProviderResponse?, error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<ProviderResponse> 
     */
    public class func getProviderWithRequestBuilder(npi npi: String) -> RequestBuilder<ProviderResponse> {
        ...
        let requestBuilder: RequestBuilder<ProviderResponse>.Type = vericred_clientAPI.requestBuilderFactory.getBuilder()
