...
public class PlanSearchResult: JSONEncodable {
    ...
    public var matchPercentage: Int32?
    /** Percentage of employees with 100% match */
    public var perfectMatchPercentage: Int32?
    /** Cumulative premium amount for employees */
    public var employeePremium: Double?
    /** Cumulative premium amount for dependents */
    public var dependentPremium: Double?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["match_percentage"] = self.matchPercentage?.encodeToJSON()
        nillableDictionary["perfect_match_percentage"] = self.perfectMatchPercentage?.encodeToJSON()
        nillableDictionary["employee_premium"] = self.employeePremium
        nillableDictionary["dependent_premium"] = self.dependentPremium
