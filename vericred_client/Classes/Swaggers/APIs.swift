...
public class vericred_clientAPI {
    public static var basePath = "https://api.vericred.com/"
...
public class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:AnyObject]?, isBody: Bool) {
        ...
        addHeaders(vericred_clientAPI.customHeaders)
    }
    ...
    public func addCredential() -> Self {
        self.credential = vericred_clientAPI.credential
        return self
    }
}
